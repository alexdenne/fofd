...
- **Spotify for Podcasters:** Nature Trail audio hosting (see below)

### Nature Trail Audio Strategy

The existing Nature Trail consists of 122 MP3 files (29 stops × 4 languages) narrated by Roger McGough CBE, totalling ~508MB. Rather than hosting these directly on the website, convert them to podcast format for better distribution and user experience.

**Why Podcasts:**
- Removes 508MB from website hosting (keeps GitHub Pages lean)
- Sequential playback—listeners auto-advance between stops
- Offline downloads—walkers can download before visiting the trail
- Shareable links—"Listen on Spotify" is familiar to all ages
- Analytics—see which stops people actually listen to
- Discoverability—could surface in podcast searches

**Structure:**
- 4 separate podcast feeds (English, French, Hindi, Polish)
- Each feed has 29 episodes in walking order
- Episode titles: "Stop 1: [Location Name]" → "Stop 29: [Final Stop]"
- Show artwork: Trail map or scenic Farthing Downs photo

**Platform:** Spotify for Podcasters (formerly Anchor)
- Free, unlimited hosting
- Auto-distributes to Apple Podcasts, Spotify, Google Podcasts, etc.
- Simple web interface for uploading and managing episodes
- Embeddable players for the website

**Website Integration:**
- Embed Spotify player on /explore/nature-trail page
- Link to "Subscribe on your favourite podcast app"
- QR codes at physical trail stops can link to specific episodes
